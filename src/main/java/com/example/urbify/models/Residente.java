...
@Entity
@Table(name = "residente", uniqueConstraints = {
...
public class Residente{
    ...
    public Residente(Long id, String firstName, String lastName, String identification, String email, long telephone,
            Admin admin, Apartamentos apartamento, boolean active, Date createdAt, Date updatedAt) {
        this.id = id;
    ...
    public String toString() {
        return "Residentes [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", identification="
